<div class="sidebar shadow">
    ...
    <div class="main">
        <ul>
                ...
                <li>
                    <a href="{{ url('/admin/products') }}" class="lk-products lk-product_add lk-product_edit lk-product_gallegy_add">
                ...
                <li>
                    <a href="{{ url('/admin/users/all') }}" class="lk-user_list lk-user_edit">
